...
function createReportElement(report) {
  ...
  div.innerHTML = `
    <div class="report-header">
      <span class="report-reason ${report.reason}">${report.reason.replace('_', ' ')}</span>
      <span>${createdAt}</span>
    </div>
    ...
    <div class="report-actions">
      <button class="ban-btn danger-btn" data-report-id="${report.id}" data-user-id="${report.reportedUserId}">Ban User</button>
      <button class="warn-btn warn-btn" data-report-id="${report.id}">Warn</button>
      <button class="dismiss-btn secondary-btn" data-report-id="${report.id}">Dismiss</button>
      <button class="view-btn view-btn" data-user-id="${report.reportedUserId}">View User</button>
    </div>
  `;
...
function createUserElement(user) {
  ...
  div.innerHTML = `
    ...
    <span class="user-badge ${isBanned ? 'banned' : 'active'}">
