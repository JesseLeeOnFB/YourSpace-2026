  ...
  postBtn.onclick = async () => {
    ...
    try {
      ...
      await addDoc(collection(db, "posts"), {
        ...
        displayName: typeof auth.currentUser.displayName === "string" ? auth.currentUser.displayName : "Anonymous",
photoURL: typeof auth.currentUser.photoURL === "string" ? auth.currentUser.photoURL : "",
        likes: 0,
        dislikes: 0,
        comments: [],
        shares: 0,
