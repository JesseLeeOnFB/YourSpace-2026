...
import { getFirestore, doc, getDoc, setDoc, collection, query, where, onSnapshot, updateDoc, deleteDoc, serverTimestamp, orderBy } from "https://www.gstatic.com/firebasejs/10.12.0/firebase-firestore.js";
...
onAuthStateChanged(auth, async (user) => {
  ...
  if (profile.customCode) customProfileDiv.innerHTML = profile.customCode;
  ...
  // Load user's posts (like feed2.js)
